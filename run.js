...
if(runParams.indexOf('python') >= 0) {
  ...
  shadowsocks = spawn('ss-manager', ['-m', method, '-u', '--manager-address', ssConfig, '-t', '600', '--plugin', '/.../v2ray-plugin', '--plugin-opts', 'server;tls;host=yourdomain.com;cert=/.../fullchain.cer;key=/.../yourdomain*.key;loglevel=none' ]);
}
